package com.example.demo.imageZoom;
...
public class ImageUtil {
    ...
    public static void main(String[] args) throws Exception {
        File fromFile = new File("D:\\章.png");
        File toFile = new File("D:\\章_s.png");
//        resizePng(fromFile, toFile, 150, 75, false);//名
        resizePng(fromFile, toFile, 150, 150, false);//章
    }
}